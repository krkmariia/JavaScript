...
let genereteNotes = () => { 
    ...
    notesStore.map((el,index) => {
        ...
        <div class="noteBlock" id="note${index}" style="background:${el.color}">
            ...
            <button id="btnChange${index}"><img class="icon" src="https://cdn-icons-png.flaticon.com/512/159/159843.png"/></button>
    ...
    for(let i=0;i<=notesStore.length-1;i++){
        if(!notesStore[i].statusDelete){
            ...
            btnsChange[i].addEventListener('click', () => {
                ...
                <button id="btnSave${i}"><img class="icon" src="https://cdn-icons-png.flaticon.com/512/7710/7710008.png"/></button>
